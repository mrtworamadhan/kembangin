        ...
        <form wire:submit="authenticate" class="space-y-5 relative z-10">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" wire:model="email" required autofocus autocomplete="username" class="w-full bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-700 text-zinc-800 dark:text-zinc-100 rounded-xl py-3.5 pl-11 pr-4 focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm font-medium transition-all" placeholder="istri@kembangin.com">
                </div>
